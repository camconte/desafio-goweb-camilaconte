...
func main() {
	...
	ticketsHandler := handler.NewTicketHandler(service)
	...
	tr := r.Group("/ticket")
	tr.GET("/getAll", ticketsHandler.GetAll())
	// GET - “/ticket/getByCountry/:dest”
	tr.GET("/getByCountry/:dest", ticketsHandler.GetTicketsByCountry())
	// GET - “/ticket/getAverage/:dest”
	tr.GET("getAverage/:dest", ticketsHandler.AverageDestination())
